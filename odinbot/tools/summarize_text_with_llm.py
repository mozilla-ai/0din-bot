...
def summarize_text_with_llm(
    text: str, summary_length: str = "a concise paragraph", model: str = "gpt-4o-mini"
) -> str:
    ...
    system_prompt = "You are an expert summarizer, skilled in extracting key information and presenting it clearly and concisely."
    user_prompt = f"Summarize the following text. The desired summary style is: {summary_length}.\n\nText:\n---\n{text}\n---"
