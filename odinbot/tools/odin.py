...
INVALID_UUID_MSG: str = (
    "The UUID you provided is not valid. Please provide a valid UUID."
)
...
async def get_threatfeed() -> dict:
    ...
    if response.status_code != 200:
        ...
        return {
            "error": API_RETURNED_STATUS_MSG.format(
...
def format_threatfeed_summary(feed_data: dict) -> str:
    ...
    tickets = (
        feed_data.get("tickets")
        or feed_data.get("results")
    ...
    for ticket in tickets:
        ...
        title = (
            ...
            or ticket.get("description", "<no title>")
        )
